...
func Executable(proxyURL string) (string, error) {
	executableOnce.Do(func() {
		executablePath, executableErr = resolveExecutable(findInstalledExecutable, func() (string, error) {
...
func resolveExecutable(lookPath func(string) (string, error), download func() (string, error)) (string, error) {
...
func downloadChromium(proxyURL string) (string, error) {
	...
	browser.RootDir = filepath.Join(cacheDir, "cpa-codex-auth", "chromium")
	if proxyURL != "" {
